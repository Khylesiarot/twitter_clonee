...
import 'package:twitter_clonee/Screens/notificationscreens/allscreen.dart';
import 'package:twitter_clonee/Screens/notificationscreens/mention.dart';
import 'package:twitter_clonee/Screens/notificationscreens/verified.dart';
...
class Notif extends State<NotifScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: TabBarView(
          controller: tabControllerS,
          children: const [Allnotif(), Vernotif(), Mentnot()]),
    );
  }
}
